    ...
    <div className="flex-1">
      ...
      <div className="flex flex-col justify-between p-10 h-full">
        ...
        <div className="flex flex-col justify-between h-0 sm:h-3/6" >
          ...
          <button onClick={() => setSkillLevel("Entry Level")} className="focus:ring-2 focus:ring-purple-600 bg-gray-200 text-left active:bg-purple-300 px-8 py-3 rounded outline-none focus:outline-none mr-1 mb-4 sm:mb-5 ease-linear transition-all duration-150" type="button">
            Entry Level
          </button>
