...
export function SignOutButton() {
  return <button onClick={() => auth.signOut()} className="text-red-600 mb-1 font-bold w-full text-center bg-white border-2 py-2 px-6 focus:outline-none rounded text-lg">Log out</button>;
}
